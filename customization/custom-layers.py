...
# The best way to implement your own layer is extending the 
# tf.keras.Layer class and implementing:
...
# models which compose many layers simply call one layer after the other. 
# This can be done using tf.keras.Sequential
